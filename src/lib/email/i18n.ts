...
const translations: Record<EmailLocale, EmailTranslations> = {
  ...
  en: {
    ...
    orderProfessionalConditions: 'B2B exclusive — Professionals only. The prices shown are for professionals. To validate your order you must prove your professional status by emailing info@tricholand.com your Certificate of economic activities (Spanish AEAT) or a VAT number verifiable in VIES. Only then will terms and prices be validated. If you cannot prove you are a professional, Tricholand may cancel the order or adjust prices to retail at its discretion.',
  ...
  nl: {
    ...
    orderProfessionalConditions: 'B2B exclusief — Alleen professionals. De getoonde prijzen zijn voor professionals. Om uw bestelling te valideren moet u uw professionele status aantonen door te e-mailen naar info@tricholand.com het Certificaat van economische activiteiten (Spaanse AEAT) of een btw-nummer verifieerbaar in VIES. Pas dan worden voorwaarden en prijzen gevalideerd. Zonder bewijs kan Tricholand de bestelling annuleren of de prijzen aanpassen aan consumentenprijzen.',
