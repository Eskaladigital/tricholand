        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          {[
            ...
            },
            {
              ...
              details: [
                'Spagna continentale: 48–72 ore (o anche meno)',
                'Unione Europea: 3 giorni lavorativi',
                'Regno Unito: 5–7 giorni lavorativi (o anche meno)',
                'Logistica e imballaggio specializzato per cactus, temperatura controllata secondo la stagione (refrigerato o riscaldato) garantendo la qualità durante il trasporto',
