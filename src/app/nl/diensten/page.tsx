        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          {[
            ...
            },
            {
              ...
              details: [
                'Vasteland Spanje: 48–72 uur (of zelfs minder)',
                'Europese Unie: 3 werkdagen',
                'Verenigd Koninkrijk: 5–7 werkdagen (of zelfs minder)',
                'Gespecialiseerde logistiek en verpakking voor cactussen, temperatuur gecontroleerd volgens seizoen (gekoeld of verwarmd) voor kwaliteit tijdens transport',
