    ...
    <>
      <section className="px-5 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          {[
            { num: '01', title: 'Großhandel', details: ['Mindestbestellung: 750 Einheiten', 'Sonderkonditionen für wiederkehrende Bestellungen und große Mengen', 'Zahlung per Überweisung', 'Individuelles Angebot in weniger als 24 Arbeitsstunden', 'Frühzeitige Produktionsreservierung verfügbar'] },
            { num: '02', title: 'Europaweiter Versand', details: ['Spanien Festland: 48–72 Stunden (oder sogar weniger)', 'Europäische Union: 3 Werktage', 'Vereinigtes Königreich: 5–7 Werktage (oder sogar weniger)', 'Spezialisierte Logistik und Verpackung für Kakteen, temperaturabhängig je nach Jahreszeit (gekühlt oder beheizt) für Qualität während des Transports', 'Echtzeit-Sendungsverfolgung', 'Versicherung bei allen Sendungen inklusive'] },
