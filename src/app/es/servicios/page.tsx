...
export const metadata: Metadata = {
  title: 'Servicios mayoristas — Tricholand',
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          {[
            ...
            },
            {
              ...
              details: [
                'España peninsular: 48–72 horas (o incluso menos)',
                'Unión Europea: 3 días hábiles',
                'Reino Unido: 5–7 días laborables (o incluso menos)',
                'Logística y embalaje especializado para cactáceas, con temperatura controlada según la estación (refrigerado o calefactado) garantizando la calidad durante el transporte',
