        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          {[
            ...
            },
            {
              ...
              details: [
                'Espanha continental: 48–72 horas (ou menos)',
                'União Europeia: 3 dias úteis',
                'Reino Unido: 5–7 dias úteis (ou menos)',
                'Logística e embalagem especializada para cactáceas, temperatura controlada conforme a estação (refrigerado ou aquecido) garantindo qualidade durante o transporte',
