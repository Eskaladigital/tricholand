        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          {[
            ...
            },
            {
              ...
              details: [
                'Espagne continentale : 48–72 heures (ou même moins)',
                'Union européenne : 3 jours ouvrés',
                'Royaume-Uni : 5–7 jours ouvrés (ou même moins)',
                'Logistique et emballage spécialisé pour cactus, température contrôlée selon la saison (réfrigéré ou chauffé) garantissant la qualité pendant le transport',
